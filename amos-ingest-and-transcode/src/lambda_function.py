...
delay_queue_url = 'https://sqs.eu-west-1.amazonaws.com/801141608259/amos-latest-forecast-morning-queue'
source_bucket = 'amos-mo-latest-forecast-ingest'
destination_bucket = 'amos-mo-latest-forecast-process'
...
def create_et_job():
    et.create_job(
        PipelineId='1539341297184-u7by82',
        Input={
