...
def make_video_from_new(new_file_name):
    ...
    video_file.write_videofile(tmp_video_file, verbose=False, progress_bar=False, codec='libx264', ffmpeg_params=['-af', 'loudnorm=I=-14:TP=-3:LRA=11:print_format=json', '-acodec', 'aac'])
